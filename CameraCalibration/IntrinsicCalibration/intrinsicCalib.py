...
parser.add_argument('-path', '--INPUT_PATH', default='/home/scjy/CameraCalibration/IntrinsicCalibration/data/', type=str, help='Input Video/Image Path')
...
parser.add_argument('-store_path', '--STORE_PATH', default='/home/scjy/CameraCalibration/IntrinsicCalibration/data/', type=str, help='Path to Store Captured Images')
